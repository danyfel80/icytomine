...
public class ViewerComponentContainer extends JPanel {
	...
	public ViewerComponentContainer(ViewProvider viewProvider) {
	...
	private void setZoomLevelButton() {
		...
		zoomLevelButton.setOpaque(false);
	...
	private void buildStatusBar() {
		...
		statusIcon.setIcon(new ImageIcon(ViewerComponentContainer.class
